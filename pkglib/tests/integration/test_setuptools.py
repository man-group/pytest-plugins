...
from pkglib_testing.pytest.util import pytest_funcarg__svn_repo, pytest_funcarg__workspace
...
def test_new_build(pypi_chishop, svn_repo, pytestconfig):
    ...
    with pkglib_testing.pypi.create_pkg(pypi_chishop, svn_repo, 'acme.newbuild1', dev=False) as pkg1:
        with pkglib_testing.pypi.create_pkg(pypi_chishop, svn_repo, 'acme.newbuild2',
